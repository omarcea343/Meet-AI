...
export const AgentIDViewLoading = () => {
	return <LoadingState title="Loading Agent" description="Please wait this may take a few seconds..." />;
};

export const AgentIDViewError = () => {
	return <ErrorState title="Error Loading Agent" description="Something went wrong, please try again later." />;
};
